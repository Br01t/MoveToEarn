...
import { Settings, Plus, Trash2, Flame, Gift, RefreshCw, Save, X, AlertTriangle, CheckCircle, Package, Target, Award, Map, Edit2, Search, ArrowRightLeft, Bug, Trophy, Calendar, BarChart3, User } from 'lucide-react';
...
const Admin: React.FC<AdminProps> = ({ 
  ...
  const startEditLeaderboard = (lb: LeaderboardConfig) => {
      ...
      if (lb.endTime) {
           ...
           // datetime-local expects YYYY-MM-DDThh:mm based on local time
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 space-y-8 relative">
      ...
      {/* ... (Other Tabs: ITEMS, MISSIONS, ZONES, ECONOMY - preserved from existing code) ... */}
      {/* ITEM MANAGER */}
      {activeTab === 'ITEMS' && (
