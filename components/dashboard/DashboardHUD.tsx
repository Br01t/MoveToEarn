...
const DashboardHUD: React.FC<DashboardHUDProps> = ({ runBalance, govBalance, earningRate }) => {
  ...
  return (
    <div className="absolute top-2 left-2 right-2 z-20 flex overflow-x-auto no-scrollbar gap-2 pointer-events-auto pr-12">
         <div className="bg-gray-800/90 backdrop-blur-md px-3 py-1.5 rounded-full border border-gray-700 shadow-xl flex items-center gap-2 shrink-0">
         ...
         {earningRate > 0 && (
            <div className="bg-emerald-900/50 backdrop-blur-md px-3 py-1.5 rounded-full border border-emerald-500/30 shadow-xl flex items-center gap-2 shrink-0">
