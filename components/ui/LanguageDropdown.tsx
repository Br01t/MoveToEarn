    ...
    return (
        <div className="relative inline-block leading-none" ref={dropdownRef}>
            <button
                ...
                className={`flex items-center justify-center gap-1.5 px-2.5 rounded-lg transition-all duration-300 border h-[32px] min-w-[46px] ${
                    isOpen 
            ...
            {isOpen && (
                <div 
                    className={`absolute top-full mt-1.5 w-40 glass-panel-heavy rounded-xl border border-white/10 shadow-2xl z-[100] overflow-hidden animate-zoom-in ${
                        ...
                        {languages.map((lang) => (
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    <div className="w-5 h-5 flex items-center justify-center text-base leading-none shrink-0">
                                        {lang.flag}
                                    </div>
