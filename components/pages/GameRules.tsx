...
import { Scroll, Map, Shield, Coins, TrendingUp, Zap, Footprints, ArrowLeft, ShoppingBag, Route, Upload, Globe, Crown, Lock, FileText, CheckCircle, HelpCircle, AlertTriangle, Target, Calculator, Database, Siren, Flame, Gift, Clock } from 'lucide-react';
                    ...
                    <table className="w-full text-left text-sm">
                        ...
                        <tbody className="divide-y divide-gray-700">
                            ...
                            <tr className="hover:bg-gray-750">
                                ...
                                <td className="px-6 py-4"><span className="bg-cyan-900/30 text-cyan-400 px-2 py-1 rounded text-xs border border-cyan-500/20 font-bold tracking-wide">SEASONAL</span></td>
