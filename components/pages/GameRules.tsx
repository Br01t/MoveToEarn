        ...
        <div className="space-y-24">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="bg-gray-800/40 backdrop-blur-md rounded-2xl border border-gray-700 p-8 hover:border-cyan-500/30 transition-colors">
                ...
                <p className="text-gray-400 text-sm leading-relaxed mb-6">
                  The ultimate store of value. It represents prestige and accumulation of wealth within the game. It is not for voting, but for
                  ranking and premium access.
                </p>
                <div className="space-y-3">
                  <div className="flex items-center gap-3 text-sm text-gray-300">
                    <span className="w-16 text-xs font-bold text-gray-500 uppercase">Source</span>
                    <span>Zone Conquests, Minting Rewards, Leaderboard Airdrops</span>
                  </div>
                  <div className="flex items-center gap-3 text-sm text-gray-300">
                    <span className="w-16 text-xs font-bold text-gray-500 uppercase">Sink</span>
            ...
            <div className="bg-gray-800/60 rounded-xl border border-gray-700 p-8 relative overflow-hidden">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 relative z-10">
                <div>
                  ...
                  <p className="text-gray-400 text-sm leading-relaxed mb-6">
                    To maintain the value of RUN, the protocol executes a "Burn Event" every Sunday at 00:00 UTC. A percentage (typically 10-20%) of
                    the global floating RUN supply is permanently removed from circulation.
                  </p>
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm leading-relaxed mb-4">
                    Simultaneously, the protocol mints a fixed supply of GOV tokens and distributes them to active players. Your reward is calculated
                    based on your contribution relative to the total network.
                  </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              <div className="lg:col-span-2 bg-gray-900 border border-gray-700 rounded-xl p-6 relative overflow-hidden">
                ...
                <p className="text-sm text-gray-400">
                  Zones generate passive income every 10 minutes based on their Interest Rate. The rate increases when the owner runs in their own
                  zone (Reinforcement) or applies a Boost item.
                </p>
              </div>
          ...
          <section>
                  ...
                  <tbody className="divide-y divide-gray-700">
                    <tr className="hover:bg-gray-750">
                      ...
                      <td className="px-6 py-4">
                        <span className="bg-blue-900/30 text-blue-400 px-2 py-1 rounded text-xs">DEFENSE</span>
                      </td>
                    ...
                    <tr className="hover:bg-gray-750">
                      ...
                      <td className="px-6 py-4">
                        <span className="bg-amber-900/30 text-amber-400 px-2 py-1 rounded text-xs">BOOST</span>
                      </td>
                    ...
                    <tr className="hover:bg-gray-750">
                      ...
                      <td className="px-6 py-4">
                        <span className="bg-cyan-950 text-cyan-400 px-2 py-1 rounded text-xs border border-cyan-500/20 font-bold tracking-wide">
                          SEASONAL / LIMITED
                        </span>
                      </td>
            ...
            <div className="bg-gradient-to-r from-yellow-900/20 to-transparent border-l-4 border-yellow-500 p-6 rounded-r-xl flex items-start gap-4">
              ...
              <div>
                <h4 className="font-bold text-white text-lg mb-1 flex items-center gap-2">Limited Market Availability & Flash Drops</h4>
                <p className="text-gray-400 text-sm leading-relaxed">
                  Premium items like the <strong>GOV Supply Crate</strong> are <u>not permanently in stock</u>. They are released in limited
                  quantities during specific <strong>Flash Drops</strong> or scheduled Seasonal Events. Players must act quickly when stock arrives,
                  as global quantities are strictly scarce.
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-gray-800 p-6 rounded-xl border border-gray-700">
                ...
                <p className="text-gray-400 text-sm mb-4">
                  The protocol is designed for walking, jogging, and running. Activities exceeding human capabilities are automatically rejected by
                  the Oracle.
                </p>
              ...
              <div className="bg-gray-800 p-6 rounded-xl border border-gray-700">
                ...
                <ul className="space-y-3 text-sm text-gray-400">
                  <li className="flex gap-3 items-start">
                    ...
                    <span>
                      <strong>Standard (Free):</strong> Files (.gpx) are queued for "Anti-Fraud Parser" analysis. Delay: 1-5 minutes.
                    </span>
                  </li>
                  <li className="flex gap-3 items-start">
                    <CheckCircle size={16} className="text-amber-400 mt-0.5 shrink-0" />
                    <span>
                      <strong>Premium (Pro):</strong> Direct API connection to Strava/Garmin. Trusted device data is accepted instantly.
                    </span>
                  </li>
                </ul>
              </div>
