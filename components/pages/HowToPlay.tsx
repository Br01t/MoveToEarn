    ...
    <div className="max-w-4xl mx-auto p-8 space-y-8 pb-24">
      ...
      <div className="bg-gray-800 rounded-xl p-8 border border-gray-700 relative overflow-hidden">
        ...
        <p className="text-gray-300 mb-4">
          ZoneRun does not track you in real-time. You must record your activity using your favorite fitness app (Strava, Garmin, Nike Run Club,
          etc.).
        </p>
        ...
        <div className="border-t border-gray-700 pt-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="bg-gray-900 p-4 rounded-lg border border-gray-700/50">
              ...
              <ol className="text-xs text-gray-400 list-decimal list-inside space-y-2">
                <li>
                  Log in to <strong>strava.com</strong> on your computer (export is restricted on mobile app).
                </li>
                <li>Click on the activity you just finished.</li>
                <li>
                  Click the <strong>(...)</strong> three dots menu on the left sidebar.
                </li>
                <li>
                  Select <strong>Export GPX</strong>.
                </li>
              </ol>
            </div>
            ...
            <div className="bg-gray-900 p-4 rounded-lg border border-gray-700/50">
              ...
              <ol className="text-xs text-gray-400 list-decimal list-inside space-y-2">
                <li>
                  Log in to <strong>connect.garmin.com</strong>.
                </li>
                ...
                <li>
                  Select <strong>Export to GPX</strong> or TCX.
                </li>
              </ol>
            </div>
          </div>
          ...
          <p className="text-[10px] text-gray-500 mt-4 italic">
            *Tip: For Apple Health, Nike Run Club, or Adidas Running, you may need a 3rd party sync tool (like "RunGap" on iOS or "SyncMyTracks" on
            Android) to export the raw file.
          </p>
        </div>
      </div>
      ...
      <div className="bg-gray-800 rounded-xl p-8 border border-gray-700 relative overflow-hidden">
        ...
        <p className="text-gray-300 mb-4">Once your run is validated, the game checks your GPS coordinates against the game map.</p>
        <ul className="space-y-4">
          <li className="flex gap-3">
            <div className="bg-emerald-900/50 p-2 h-fit rounded text-emerald-400">
              <MapPin size={20} />
            </div>
            <div>
              <strong className="text-white">New Zone (Minting)</strong>
              <p className="text-sm text-gray-400">
                If no one owns this area, you can pay <strong>50 RUN</strong> to Mint it. You become the owner and earn <strong>5 GOV</strong>{" "}
                immediately.
              </p>
            </div>
          </li>
          <li className="flex gap-3">
            <div className="bg-red-900/50 p-2 h-fit rounded text-red-400">
              <Trophy size={20} />
            </div>
            <div>
              <strong className="text-white">Existing Zone (Conquest)</strong>
              <p className="text-sm text-gray-400">
                If the zone is owned by someone else, you can challenge them. If you run more KM in that zone than their record, you take ownership!
                Conquest costs <strong>50 RUN</strong> but awards <strong>10 GOV</strong>.
              </p>
            </div>
          </li>
          <li className="flex gap-3">
            <div className="bg-blue-900/50 p-2 h-fit rounded text-blue-400">
              <Shield size={20} />
            </div>
            <div>
              <strong className="text-white">Your Zone (Reinforce)</strong>
              <p className="text-sm text-gray-400">
                If you run in a zone you already own, you increase its Defense Level, making it harder for others to steal.
              </p>
            </div>
          </li>
        </ul>
